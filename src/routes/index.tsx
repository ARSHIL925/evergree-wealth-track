...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Mindful money for India: expenses, UPI, calculator, monthly blog." },
      ...
      { name: "twitter:description", content: "Mindful money for India: expenses, UPI, calculator, monthly blog." },
    ],
